...
!
 ...
 if(startup)then
  ...
  print *, ' '
  call read_cross_sections( nemod,bxs,ifl)
  call create_energy_grid(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
  startup=.false.  
 endif
...
! To read the cross-sections once for each dataset
 if(a.lt.ifl)then
  a= a+1
  print *, 'Loading atomic-data for dataset',ifl
  call read_cross_sections( nemod,bxs,ifl)
  call create_energy_grid(1.d1,1.d4,bener,nemod) !Absorption coefficient calculation grid  = cross section grid
 endif
...
!
 call absorption(nH, N_He_0, N_He_1, N_C_0, N_C_1, N_C_2, &
...
!
 call map_to_grid(dble(ear),ne,emod,nemod,photar,coemod,ifl)
...
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++!
subroutine read_cross_sections(bnene,xs,ifl)
!
...
! ======================================= !
 subroutine absorption(col22, N_He_0, N_He_1, N_C_0, N_C_1, N_C_2, &
 N_N_0, N_N_1, N_N_2, N_O_0, N_O_1, N_O_2, &
 N_Ne_0, N_Ne_1, N_Ne_2, N_Mg_0, N_Mg_1, N_Mg_2, &
 N_Si_0, N_Si_1, N_Si_2, N_S_0, N_S_1, N_S_2, &
 N_Ar_0, N_Ar_1, N_Ar_2, N_Ca_0, &
...
! ======================================= !
 ...
 subroutine map_to_grid(new_en,nne,old_en, one,   nflux, old_flu,ifl)
...
! ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine create_energy_grid(emin,emax,en,nen)
 implicit none
 integer :: i, nen
